...
def fix_remaining_issues():
    ...
    content = re.sub(r"(\s+)trajectory_ids_list = \[", r"\1# trajectory_ids_list = [", content)

    content = re.sub(r"(\s+)all_obs_sequences = \[", r"\1# all_obs_sequences = [", content)
    ...
    with open(mlops_path, encoding="utf-8") as f:
        content = f.read()
    ...
    with open(monitoring_path, encoding="utf-8") as f:
        content = f.read()
